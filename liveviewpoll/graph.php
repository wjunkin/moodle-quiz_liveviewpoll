...
require_once($CFG->dirroot.'/mod/quiz/report/liveviewpoll/classes/quiz_liveviewpoll_graphlib.php');
...
$line = new quiz_liveviewpoll_graphlib(700, 500);
$line->parameter['title']   = '';
$line->parameter['y_label_left'] = get_string('numberofresponses', 'quiz_liveviewpoll');
